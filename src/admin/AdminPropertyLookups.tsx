...
> = {
  property_listing_tags: {
    ...
    blurb:
      'Labels such as “For sale” and “New”. They appear on property cards and drive filters (e.g. new developments). Add or reorder options here; the listing editor loads this list.',
    singular: 'tag',
    columnLabel: 'Tag',
